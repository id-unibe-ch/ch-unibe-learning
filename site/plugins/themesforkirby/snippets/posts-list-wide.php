  ...
  <div class="<?= $class ?>">
    ...
    <?php if ($page->media()->bool() && $cover = $post->cover()->toFile()): ?>
      ...
      <?php if ($page->mediaFixedHeight()->bool() === false): ?>
        <a href="<?php if ($post->externalLink()->isNotEmpty()): ?><?= $post->externalLink() ?><?php else: ?><?= $post->url() ?><?php endif ?>" class="<?php if ($page->mediaBorder()->bool()): ?>border border-img <?php endif ?>full-width position-relative<?php if ($page->mediaRounded()->bool()): ?> rounded<?php endif ?><?php if ($page->mediaShadow()->value() !== 'none'): ?> shadow-<?= $page->mediaShadow() ?><?php endif ?> space-bottom-2x text-decoration-none"<?php if ($post->externalLink()->isNotEmpty()): ?> target="_blank" rel="noopener noreferrer"<?php endif ?>>
      ...
      <?php else: ?>
        <a href="<?php if ($post->externalLink()->isNotEmpty()): ?><?= $post->externalLink() ?><?php else: ?><?= $post->url() ?><?php endif ?>" class="align-items-<?= $page->mediaPositionVertical() ?> <?php if ($page->mediaBorder()->bool()): ?>border border-img <?php endif ?>full-width max-height-lg position-relative<?php if ($page->mediaRounded()->bool()): ?> rounded<?php endif ?><?php if ($page->mediaShadow()->value() !== 'none'): ?> shadow-<?= $page->mediaShadow() ?><?php endif ?> space-bottom-2x text-decoration-none"<?php if ($post->externalLink()->isNotEmpty()): ?> target="_blank" rel="noopener noreferrer"<?php endif ?>>
