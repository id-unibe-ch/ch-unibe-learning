"use strict";var el,el,el,el;(el=document.querySelector(".header-toggle"))&&el.addEventListener("click",(function(){document.body.classList.toggle("no-scroll"),document.querySelector(".header-main").classList.toggle("active")})),(el=document.querySelector(".icon-search"))&&el.addEventListener("click",(function(){document.body.classList.remove("no-scroll"),document.querySelector(".header-main").classList.remove("active"),document.querySelector(".search").classList.toggle("active"),document.querySelector(".search-overlay").classList.toggle("active"),document.getElementById("search").focus()})),(el=document.querySelector(".search-overlay"))&&el.addEventListener("click",(function(){document.body.classList.remove("no-scroll"),document.querySelector(".search").classList.toggle("active"),document.querySelector(".search-overlay").classList.toggle("active")})),(el=document.querySelector(".sidebar-toggle"))&&el.addEventListener("click",(function(){document.querySelector(".sidebar-nav").classList.toggle("active")}));let throttleTimer=!1;const throttle=(t,e)=>{throttleTimer||(throttleTimer=!0,setTimeout((()=>{t(),throttleTimer=!1}),e))},scrollElements=document.querySelectorAll(".js-animation"),elementInView=(t,e=1)=>{const i=undefined;return t.getBoundingClientRect().top<=(window.innerHeight||document.documentElement.clientHeight)/e},elementOutofView=t=>{const e=undefined;return t.getBoundingClientRect().top>(window.innerHeight||document.documentElement.clientHeight)},displayScrollElement=t=>{t.classList.add("js-scrolled")},hideScrollElement=t=>{t.classList.remove("js-scrolled")},handleScrollAnimation=()=>{scrollElements.forEach((t=>{elementInView(t,1)?displayScrollElement(t):elementOutofView(t)&&hideScrollElement(t)}))};window.addEventListener("scroll",(()=>{throttle(handleScrollAnimation,100)})),
/*!
